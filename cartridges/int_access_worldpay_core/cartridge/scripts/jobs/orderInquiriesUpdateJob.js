    ...
    if (ordersReturnedByQueryIterator.getCount() > 0) {
        while (ordersReturnedByQueryIterator.hasNext()) {
            ...
            if (!checkWorldpayOrderResult.WorldpayOrderFound) {
                ...
                sendWorldpayOrderInquiriesRequestResult = require('*/cartridge/scripts/pipelets/sendWorldpayOrderInquiriesRequest').sendWorldpayOrderInquiriesRequest(orderReturnedByQuery, paymentInstr);
