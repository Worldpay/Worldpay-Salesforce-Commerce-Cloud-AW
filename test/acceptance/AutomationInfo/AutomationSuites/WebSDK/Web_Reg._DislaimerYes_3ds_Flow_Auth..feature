Feature: WEB SDK Checkout | Registered Disclaimer Yes Option - 3DS Flow
...
@Reg._DisclaimerYes_WebSDK_Master_3ds1-challenge-identified_Auth.
    Scenario: Reg._DisclaimerYes_WebSDK_Master_3ds1-challenge-identified_Auth. | 3DS Challenge Flow
...
@Reg._DisclaimerYes_WebSDK_VisaDebit_3ds2-challenge-identified_Auth.
    Scenario: Reg._DisclaimerYes_WebSDK_VisaDebit_3ds2-challenge-identified_Auth. | 3DS Challenge Flow
    	Then Shopper searches for "Hammered Gold Earrings" and naviagtes to PDP
		Then Shopper add the product to cart and click to Checkout
		Then Shopper enters "UnitedStates" shipping address
		And clicks on NextPayment button to navigate to payment section 
...
@Reg._DisclaimerYes_WebSDK_MasterDebit_3ds1-verification-unavailable_Auth.
    Scenario: Reg._DisclaimerYes_WebSDK_MasterDebit_3ds1-verification-unavailable_Auth. | 3DS Challenge Flow
    	Then Shopper searches for "Hammered Gold Earrings" and naviagtes to PDP
		Then Shopper add the product to cart and click to Checkout
		...
		Then Shopper clicks on Challenge OK Button and navigates to order confirmation page
		And log the order and payment details
		|Reg._DisclaimerYes_WebSDK_MasterDebit_Visa_3ds1-verification-unavailable_Auth.|
		Then Go to MyAccount Page
		And Click on Payment View
		And Verify saved card details
		|Name on Card|Expiry|
...
@Reg._DisclaimerYes_WebSDK_Amex_3ds1-bypassed_Auth.
    Scenario: Reg._DisclaimerYes_WebSDK_Amex_3ds1-bypassed_Auth. | 3DS NoChallenge Flow
    	Then Shopper searches for "Hammered Gold Earrings" and naviagtes to PDP
		Then Shopper add the product to cart and click to Checkout
		Then Shopper enters "UnitedStates" shipping address
		And clicks on NextPayment button to navigate to payment section 
...
@Reg._DisclaimerYes_WebSDK_VisaElectron_3ds1-authentication-unavailable_Auth.
    Scenario: Reg._DisclaimerYes_WebSDK_VisaElectron_3ds1-authentication-unavailable_Auth. | 3DS NoChallenge Flow
    	Then Shopper searches for "Hammered Gold Earrings" and naviagtes to PDP
		Then Shopper add the product to cart and click to Checkout
		...
		And Shopper adds payment details on websdk payment form
			|Name on Card |Card Number |Expiry|CVV|
			|3ds1-authentication-unavailable|4917300800000000|03/24|324|
		And selects Disclaimer Yes Option web
		Then Shopper clicks on Next Review Order Button to navigate to order review page
		Then Shopper clicks on Place Order Button
		And log the order and payment details
		...
		Then Shopper clicks on Place Order Button
		And log the order and payment details
		|Reg._DisclaimerYes_WebSDK_Visa_3ds1-authentication-unavailable_Auth.|
		Then Go to MyAccount Page
		And Click on Payment View
		And Remove the Saved Payment 

@Reg._DisclaimerYes_WebSDK_Visa_3ds2-frictionless-identified_Auth.
    Scenario: Reg._DisclaimerYes_WebSDK_Visa_3ds2-frictionless-identified_Auth. | 3DS NoChallenge Flow
    	Then Shopper searches for "Hammered Gold Earrings" and naviagtes to PDP
		Then Shopper add the product to cart and click to Checkout
		Then Shopper enters "Singapore" shipping address
		And clicks on NextPayment button to navigate to payment section 
		...
		And Shopper adds payment details on websdk payment form
			|Name on Card |Card Number |Expiry|CVV|
			|3ds2-frictionless-identified|4444333322221111|04/24|424|
		And selects Disclaimer Yes Option web
		Then Shopper clicks on Next Review Order Button to navigate to order review page
		Then Shopper clicks on Place Order Button
		And log the order and payment details
		|Reg._DisclaimerYes_WebSDK_MasterDebit_Visa_3ds2-frictionless-identified_Auth.|
		Then Go to MyAccount Page
		And Click on Payment View
		And Verify saved card details
		|Name on Card|Expiry|
...
@Reg._DisclaimerYes_WebSDK_VisaPurchasing_3ds2-frictionless-not-identified_Auth.
    Scenario: Reg._DisclaimerYes_WebSDK_VisaPurchasing_3ds2-frictionless-not-identified_Auth. | 3DS NoChallenge Flow
    	Then Shopper searches for "Hammered Gold Earrings" and naviagtes to PDP
		Then Shopper add the product to cart and click to Checkout
