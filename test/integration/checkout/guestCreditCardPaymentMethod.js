...
describe('Place Order - Guest User Direct Credit Card Payment Method',function(){
	this.timeout(45000);
	...
	it('Positive test for placing order by Guest User using credit card payment',function(){
