...
describe('Place Order - Registered User Credit Card Payment Method using Saved Cards', function () {
	this.timeout(25000);
        ...
        return request(myRequest)
            ...
            .then(function (response) {
               // console.log(JSON.stringify(response));
                ...
                // console.log('Authorization token : ' + authBearer);
                assert.equal(response.statusCode, 200, 'Expected statusCode to be 200.');
            })
            ...
            .then(function (response) {
                ...
                // console.log('Stored Payment UUID : ' + UUID);
            })
			// ----csrf token generation
            .then(function () {
                myRequest.method = 'POST';
	...
	it('Positive test for Saved Credit Card', function () {
        ...
        return request(myRequest)
            ...
            .then(function (response) {
				...
				assert.isNotNull(bodyAsJson, 'Response body should not be null.');
                assert.equal(response.statusCode, 200, 'Expected statusCode to be 200.');
